		...
		<div class="container">
			...
			<div class="about-agileinfo w3layouts">
				<div class="col-md-8 about-wthree-grids grid-top">
					...
					<p class="top">Celebrate Pro Have the perfect innovative team, who can come up with unique theme. Whoever's birthday party it may be a child or it may be elder's birthday party. We have a range of theme party of childrens.</p>
		...
		<div class="container">
			...
			<div class="servcs-info">
				<div class="col-md-6 sevcs-grids">
					...
					<p>Celebrate like never before with Celebrate Pro making the birthday party cheerful, frantic function. We take care of everything i.e. decoration, cakes, balloon bouuqutes, DJ, live entertainment, bands, magicians, dance troops, fun, games, photography/video, lighting, stage show, fireworks and so on.</p>			
				</div>
				<div class="col-md-6 sevcs-grids"> 
					<h4><span>02.</span> THEME PARTY</h4>
					<p>Celebrate your happy moods with Celebrate Pro. Top-notch theme parties can be organized within your budget and location. You can make them happen.</p>			
				</div>
				<div class="clearfix"> </div>
			</div>
